...
def render_adaptive(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, override_mask = None, filtered_mask = None, iteration=None, coarse_iteration=None):
    """
    Render the scene. 
